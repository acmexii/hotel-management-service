...
pluralCaseList.push( {plural: "reservationManagements/reservations", pascal: "ReservationManagementReservation"} )

pluralCaseList.push( {plural: "roomManagements/rooms", pascal: "RoomManagementRoom"} )

pluralCaseList.push( {plural: "checkinoutManagements/checkInOuts", pascal: "CheckinoutManagementCheckInOut"} )

pluralCaseList.push( {plural: "paymentManagements/payments", pascal: "PaymentManagementPayment"} )
