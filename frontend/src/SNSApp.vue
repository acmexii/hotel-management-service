            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="checkInOuts"
                        to="/checkinoutManagements/checkInOuts"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="payments"
                        to="/paymentManagements/payments"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: 'Reservation', 
                description: 'A reservation made by a customer for a hotel room', 
                key: 'reservations', 
            ...
            { 
                title: 'Room', 
                description: 'A room in the hotel', 
                key: 'rooms', 
                route: '/roomManagements/rooms',
                ImageUrl: '',
            },
            { 
                title: 'Check-in/out', 
                description: 'The check-in/check-out process of a customer', 
                key: 'checkInOuts', 
                route: '/checkinoutManagements/checkInOuts',
                ImageUrl: '',
            },
            { 
                title: 'Payment', 
                description: 'The payment information of a customer', 
                key: 'payments', 
                route: '/paymentManagements/payments',
                ImageUrl: '',
            },
